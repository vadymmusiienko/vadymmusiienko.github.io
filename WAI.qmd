...
subtitle: Exploring the WAI Database
...
analysis, we use the same set of publications. Participant sex
information is retrieved from the Subjects table, which is joined with
