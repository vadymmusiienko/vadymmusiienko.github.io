...
1.  Reproduce Figure 1 from Voss (2020), which illustrates mean
...
(2020)](https://pmc.ncbi.nlm.nih.gov/articles/PMC7093226/), we first
...
publications used in Voss (2020): Abur_2014, Feeney_2017, Groon_2015,
...
analysis, we use the same set of publications.
...
absorbance between male and female participants:
...
This plot reveals that female participants exhibit higher absorbance
than males around the 800 Hz frequency range. However, the difference
diminishes below 800 Hz and beyond 5000 Hz, where absorbance levels for
both sexes are nearly identical.

#### Disconnect from the Database

The last step is to disconnetc from the database.
...
The DOI of this project is: [doi.org/10.35482/egr.001.2022](https://doi.org/10.35482/egr.001.2022)

Contributors to this work include:

-   Dr. Susan E. Voss, Picker Engineering Program, Smith College
-   Dr. Nicholas J. Horton, Professor of Statistics and Data Science,
    Amherst College
-   Dr. Benjamin Baumer, Statistical and Data Sciences, Smith College
-   Suzanne Palmer Computing and Technical Services (CATS), Smith
    College
